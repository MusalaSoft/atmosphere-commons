...
public class IntentBuilder
{
	...
	{
		START_COMPONENT(null, "start"), ATMOSPHERE_TEXT_INPUT("atmosphere.intent.action.TEXT", "broadcast"), AIRPLANE_MODE_NOTIFICATION(
				"android.intent.action.AIRPLANE_MODE", "broadcast"), BATTERY_LOW("android.intent.action.BATTERY_LOW",
